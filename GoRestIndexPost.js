...
//       "name":"Test Amit",
//       "gender":"male",
//       "email":"string987625626@gmail.com",
//       "status":"active"
//     }
//     },
...
async function main (params) {
  ...
  try {
      ...
      body: JSON.stringify(
          {
            "name":"Test Amit", 
            "gender":"male", 
            "email":"string123878+123455@gmail.com", 
            "status":"active"
        }
      ),
    })
    ...
    //     },
    //   })
    // throw new Error('request to ' + apiEndpoint + ' failed with status code ' + JSON.stringify(res.json()))
    if (!res.ok) {
    ...
    logger.error(error)
    // return with 500
    // return errorResponse(res.status, JSON.stringify(response),logger)
